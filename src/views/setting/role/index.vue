<template>
	<el-container>
		...
		<el-main class="nopadding">
			<scTable ref="table" :apiObj="apiObj" row-key="roleId" @selection-change="selectionChange" stripe>
				<el-table-column type="selection" width="50"></el-table-column>
				<el-table-column label="序号" type="index" width="50"></el-table-column>
				<el-table-column label="角色名称" prop="roleName" width="150"></el-table-column>
				<el-table-column label="别名" prop="roleAlias" width="200"></el-table-column>
	...
	export default {
		...
		methods: {
			...
			async table_del(row){
				...
				var res = await this.$API.system.role.del.post(reqData);
				if(res.code == 200){
			...
			async batch_del(){
				this.$confirm(`确定删除选中的 ${this.selection.length} 项吗？如果删除项中含有子集将会被一并删除`, '提示', {
					...
					var res = await this.$API.system.role.batchDel.post(this.selection);
					console.info(res)
					this.$refs.table.refresh()
					loading.close();
